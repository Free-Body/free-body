...
//         ? ((this.textureChange = !0), (this.texture = a))
//         : (this.texture = a),
...
//           if (
//             (c.setTransform(f[0], f[3], f[1], f[4], f[2], f[5]),
//             this.blendMode !== a.currentBlendMode &&
//               ((a.currentBlendMode = this.blendMode),
//               (c.globalCompositeOperation =
//                 e.blendModesCanvas[a.currentBlendMode])),
//             16777215 !== this.tint)
//           ) {
...
//               b.width,
//               b.height,
//               this.anchor.x * -b.width,
//               this.anchor.y * -b.height,
//               b.width,
//               b.height
//             );
//           } else if (d.trimmed) {
...
//               b.width,
//               b.height,
//               g.x - this.anchor.x * g.realWidth,
//               g.y - this.anchor.y * g.realHeight,
//               b.width,
//               b.height
//             );
//           } else
...
//           ? (i.x += d - c[f])
//           : "center" === this.style.align && (i.x += (d - c[f]) / 2),
//           this.style.stroke &&
//             this.style.strokeThickness &&
...
//       for (
//         var a = e.BitmapText.fonts[this.fontName],
//           b = new e.Point(),
//           c = null,
//           d = [],
//           f = 0,
...
//             (f.mouseover || f.mouseout || f.buttonMode) &&
//               ((f.__hit = this.hitTest(f, this.mouse)),
//               (this.mouse.target = f),
//               f.__hit
//                 ? (f.buttonMode && (this.currentCursor = f.defaultCursor),
//                   f.__isOver ||
//                     (f.mouseover && f.mouseover(this.mouse), (f.__isOver = !0)))
//                 : f.__isOver &&
//                   (f.mouseout && f.mouseout(this.mouse), (f.__isOver = !1)));
//           }
//           this.currentCursor !== this.interactionDOMElement.style.cursor &&
...
//           d.__hit &&
//             (d.mousedown && d.mousedown(this.mouse),
//             (d.__isDown = !0),
...
//         k = 1 / (d * i + f * -h);
//       return new e.Point(
//         i * k * c.x + -f * k * c.y + (j * f - g * i) * k,
//         d * k * c.y + -h * k * c.x + (-j * d + g * h) * k
//       );
//     }),
...
//               t !== j &&
//               t !== k &&
//               e.PolyK._PointInTriangle(a[2 * t], a[2 * t + 1], l, m, n, o, p, q)
//             ) {
//               r = !1;
//               break;
//             }
...
//           1 === a.glValueLength
//             ? a.glMatrix === !0
//               ? a.glFunc.call(b, a.uniformLocation, a.transpose, a.value)
//               : a.glFunc.call(b, a.uniformLocation, a.value)
//             : 2 === a.glValueLength
//             ? a.glFunc.call(b, a.uniformLocation, a.value.x, a.value.y)
//             : 3 === a.glValueLength
//             ? a.glFunc.call(
//                 b,
//                 a.uniformLocation,
...
//                   b.bindTexture(
//                     b.TEXTURE_2D,
//                     a.value.baseTexture._glTextures[b.id] ||
//                       e.createWebGLTexture(a.value.baseTexture, b)
//                   ),
//                   b.uniform1i(a.uniformLocation, this.textureCount),
//                   this.textureCount++)
...
//         c.uniformMatrix3fv(g.translationMatrix, !1, i),
...
//       for (
//         var c = a._webGL[b.id], d = c.lastIndex;
//         d < a.graphicsData.length;
//         d++
//       ) {
//         var f = a.graphicsData[d];
//         f.type === e.Graphics.POLY
//           ? (f.fill && f.points.length > 3 && e.WebGLGraphics.buildPoly(f, c),
//             f.lineWidth > 0 && e.WebGLGraphics.buildLine(f, c))
//           : f.type === e.Graphics.RECT
//           ? e.WebGLGraphics.buildRectangle(f, c)
//           : (f.type === e.Graphics.CIRC || f.type === e.Graphics.ELIP) &&
//             e.WebGLGraphics.buildCircle(f, c);
//       }
...
//       return (
//         a.hasLoaded &&
//           ((a._glTextures[b.id] = b.createTexture()),
...
//             a.scaleMode === e.BaseTexture.SCALE_MODE.LINEAR
//               ? b.LINEAR
//               : b.NEAREST
//           ),
//           b.texParameteri(
...
//           b.TEXTURE_2D,
//           b.TEXTURE_MAG_FILTER,
//           a.scaleMode === e.BaseTexture.SCALE_MODE.LINEAR ? b.LINEAR : b.NEAREST
//         ),
//         b.texParameteri(
//           b.TEXTURE_2D,
//           b.TEXTURE_MIN_FILTER,
...
//       a.useProgram(b),
//         a.enableVertexAttribArray(this.defaultShader.aVertexPosition),
//         a.enableVertexAttribArray(this.defaultShader.colorAttribute),
...
//         a.disableVertexAttribArray(this.defaultShader.aVertexPosition),
//         a.disableVertexAttribArray(this.defaultShader.colorAttribute),
//         a.disableVertexAttribArray(this.defaultShader.aTextureCoord),
//         a.enableVertexAttribArray(this.primitiveShader.aVertexPosition),
...
//         a.disableVertexAttribArray(this.primitiveShader.aVertexPosition),
//         a.disableVertexAttribArray(this.primitiveShader.colorAttribute),
//         a.enableVertexAttribArray(this.defaultShader.aVertexPosition),
//         a.enableVertexAttribArray(this.defaultShader.colorAttribute),
//         a.enableVertexAttribArray(this.defaultShader.aTextureCoord);
//     }),
...
//         (this.flush(), (this.currentBaseTexture = a.texture.baseTexture)),
...
//       (b.baseTexture !== this.currentBaseTexture ||
//         this.currentBatchSize >= this.size) &&
...
//         f =
//           a.width / b.baseTexture.width / (a.tileScale.x * a.tileScaleOffset.x),
//         g =
//           a.height /
//           b.baseTexture.height /
...
//             e.createWebGLTexture(this.currentBaseTexture, a)
//         );
...
//         : (g = new e.FilterTexture(this.gl, this.width, this.height)),
...
//       if (((c.tintCache = c.tintCache || {}), c.tintCache[d]))
//         return c.tintCache[d];
//       var f = e.CanvasTinter.canvas || document.createElement("canvas");
//       if (
//         (e.CanvasTinter.tintMethod(c, b, f), e.CanvasTinter.convertTintToImage)
//       ) {
//         var g = new Image();
...
//           i = g[1],
//           j = g[2],
//           k = d.getImageData(0, 0, f.width, f.height),
//           l = k.data,
//           m = 0;
//         m < l.length;
//         m += 4
...
//         c = e.hex2rgb(a);
//       return (
//         (c[0] = Math.min(255, Math.round(c[0] / b) * b)),
//         (c[1] = Math.min(255, Math.round(c[1] / b) * b)),
//         (c[2] = Math.min(255, Math.round(c[2] / b) * b)),
//         e.rgb2hex(c)
//       );
//     }),
...
//               ),
//               (this.dirty = !1)),
//             void e.Sprite.prototype._renderWebGL.call(this._cachedSprite, a)
//           );
//         if (
//           (a.spriteBatch.stop(),
...
//       for (
//         var a, b, c, d = 1 / 0, f = -(1 / 0), g = 1 / 0, h = -(1 / 0), i = 0;
...
//             this.mask &&
//               (a.spriteBatch.stop(),
//               a.maskManager.pushMask(this.mask, a.projection),
//               a.spriteBatch.start()),
//               this.filters &&
//                 (a.spriteBatch.flush(),
//                 a.filterManager.pushFilter(this._filterBlock)),
...
//             this.mask && a.maskManager.popMask(a.projection),
//             a.spriteBatch.start();
//         } else
//           for (
//             this.tilingTexture
...
//             this.tilingTexture &&
//               (this.__tilePattern = b.createPattern(
...
//               e.blendModesCanvas[a.currentBlendMode])),
//           b.beginPath();
//         var d = this.tilePosition.x % this.tilingTexture.width,
//           f = this.tilePosition.y % this.tilingTexture.height,
//           g = this.tileScale;
//         b.scale(g.x, g.y),
//           b.translate(d, f),
//           (b.fillStyle = this.__tilePattern),
//           b.fillRect(-d, -f, this.width / g.x, this.height / g.y),
//           b.scale(1 / g.x, 1 / g.y),
//           b.translate(-d, -f),
//           b.closePath();
//       }
...
//         if (
//           (a
//             ? ((c = e.getNextPowerOfTwo(b.frame.width)),
//               (d = e.getNextPowerOfTwo(b.frame.height)),
//               g.width !== c && g.height !== d && (i = !0))
//             : h && ((c = g.width), (d = g.height), (i = !0)),
//           i)
//         ) {
//           var j = new e.CanvasBuffer(c, d);
//           j.context.drawImage(
//             b.baseTexture.source,
//             g.x,
//             g.y,
//             g.width,
//             g.height,
...
//     }),
//     (j.SlotData.prototype = { r: 1, g: 1, b: 1, a: 1, attachmentName: null }),
//     (j.Bone = function (a, b) {
...
//           j.Bone.yDown && ((this.m10 = -this.m10), (this.m11 = -this.m11));
//       },
...
//             k = 1 - (b - i) / (e[g - 2] - i);
//           for (
//             k = this.curves.getCurvePercent(g / 2 - 1, k), d = e[g + 1] - h;
//             d > 180;
...
//             return (
//               (e.scaleX +=
//                 (e.data.scaleX - 1 + d[d.length - 2] - e.scaleX) * c),
//               void (e.scaleY +=
//                 (e.data.scaleY - 1 + d[d.length - 1] - e.scaleY) * c)
//             );
//           var f = j.binarySearch(d, b, 3),
//             g = d[f - 2],
//             h = d[f - 1],
...
//           (k = this.curves.getCurvePercent(f / 3 - 1, k)),
//             (e.scaleX +=
//               (e.data.scaleX - 1 + g + (d[f + 1] - g) * k - e.scaleX) * c),
//             (e.scaleY +=
//               (e.data.scaleY - 1 + h + (d[f + 2] - h) * k - e.scaleY) * c);
//         }
//       },
//     }),
...
//         if (!(b < d[0])) {
//           var e;
//           e = b >= d[d.length - 1] ? d.length - 1 : j.binarySearch(d, b, 1) - 1;
//           var f = this.attachmentNames[e];
//           a.slots[this.slotIndex].setAttachment(
//             f ? a.getAttachmentBySlotIndex(this.slotIndex, f) : null
//           );
//         }
//       },
//     }),
...
//       }
//       for (
//         this.slots = [], this.drawOrder = [], b = 0, c = a.slots.length;
//         c > b;
//         b++
//       ) {
//         var f = a.slots[b],
...
//         for (
//           var b, c = new j.SkeletonData(), d = a.bones, e = 0, f = d.length;
//           f > e;
//           e++
//         ) {
//           var g = d[e],
...
//             m = k.color;
//           m &&
//             ((l.r = j.SkeletonJson.toColor(m, 0)),
...
//                 if (((h = q[f]), "rotate" == f)) {
//                   for (
//                     e = new j.RotateTimeline(h.length),
//                       e.boneIndex = p,
//                       d = 0,
//                       i = 0,
//                       k = h.length;
...
//                     throw (
//                       "Invalid timeline type for a bone: " + f + " (" + o + ")"
//                     );
//                   var r = 1;
//                   for (
//                     "scale" == f
//                       ? (e = new j.ScaleTimeline(h.length))
//                       : ((e = new j.TranslateTimeline(h.length)),
//                         (r = this.scale)),
//                       e.boneIndex = p,
//                       d = 0,
//                       i = 0,
...
//                 if (((h = w[f]), "color" == f)) {
//                   for (
//                     e = new j.ColorTimeline(h.length),
//                       e.slotIndex = x,
//                       d = 0,
//                       i = 0,
//                       k = h.length;
...
//                   if ("attachment" != f)
//                     throw (
//                       "Invalid timeline type for a slot: " + f + " (" + v + ")"
//                     );
//                   for (
//                     e = new j.AttachmentTimeline(h.length),
//                       e.slotIndex = x,
//                       d = 0,
//                       i = 0,
//                       k = h.length;
...
//               (g.v = i / e.height),
//               g.rotate
//                 ? ((g.u2 = (h + l) / e.width), (g.v2 = (i + k) / e.height))
//                 : ((g.u2 = (h + k) / e.width), (g.v2 = (i + l) / e.height)),
//               (g.x = h),
//               (g.y = i),
//               (g.width = Math.abs(k)),
//               (g.height = Math.abs(l)),
...
//               "x" == m
//                 ? (e.uWrap = j.Atlas.TextureWrap.repeat)
//                 : "y" == m
//                 ? (e.vWrap = j.Atlas.TextureWrap.repeat)
//                 : "xy" == m && (e.uWrap = e.vWrap = j.Atlas.TextureWrap.repeat),
//               b.load(e, f),
//               this.pages.push(e);
//           }
//         else e = null;
...
//     }),
//     (j.Atlas.TextureWrap = { mirroredRepeat: 0, clampToEdge: 1, repeat: 2 }),
...
//             if (
//               (void 0 !== f.currentSprite && (f.currentSprite.visible = !1),
//               (f.sprites = f.sprites || {}),
//               void 0 !== f.sprites[i])
//             )
...
//                 c.dispatchEvent({ type: "loaded", content: c });
//             };
//           }
//         else
//           (this.hasLoaded = !0),
...
//       this.source instanceof Image &&
//         (this.imageUrl in e.BaseTextureCache &&
...
//       return (
//         d ||
//           ((d = new e.Texture(e.BaseTexture.fromImage(a, b, c))),
//           (e.TextureCache[a] = d)),
//         d
//       );
//     }),
...
//               if (
//                 g &&
//                 ((e.TextureCache[f] = new e.Texture(this.texture, {
//                   x: g.x,
//                   y: g.y,
//                   width: g.w,
//                   height: g.h,
...
//                       h: Number(j[2]),
//                     };
//                     k.w > d.frame.w || k.h > d.frame.h
//                       ? ((d.trimmed = !0), (d.realSize = k))
//                       : (d.trimmed = !1);
//                   }
//                 }
//               b++;
...
//                 var n = m[g].frame;
//                 n &&
//                   ((e.TextureCache[g] = new e.Texture(
//                     this.images[h].texture.baseTexture,
//                     { x: n.x, y: n.y, width: n.w, height: n.h }
//                   )),
//                   m[g].trimmed &&
//                     ((e.TextureCache[g].realSize = m[g].realSize),
...
//           f = Math.floor(this.texture.height / b),
//           g = 0,
//           h = 0;
//         f > h;
//         h++
...
//           } else for (var e in b) if (c.call(d, b[e], e) === this.BREAK) return;
//       },
//       defer: function (a) {
//         setTimeout(a, 0);
//       },
...
//           return (
//             b(c["border-left-width"]) +
//             b(c["border-right-width"]) +
//             b(c["padding-left"]) +
//             b(c["padding-right"]) +
//             b(c.width)
//           );
...
//           var c = getComputedStyle(a);
//           return (
//             b(c["border-top-width"]) +
//             b(c["border-bottom-width"]) +
//             b(c["padding-top"]) +
//             b(c["padding-bottom"]) +
//             b(c.height)
//           );
...
//               ? this.getValue()
//               : d(this.getValue(), this.__precision)),
...
//         return (
//           l.setValue(f(a.clientX, c.left, c.left + d, l.__min, l.__max)), !1
//         );
//       }
//       function k() {
...
//         return (
//           n.addClass(l, M.CLASS_CONTROLLER_ROW),
...
//             name: function (a) {
//               return (
//                 (c.__li.firstElementChild.firstElementChild.innerHTML = a), c
//               );
//             },
//             listen: function () {
...
//           return (
//             a.getRoot().__preset_select && c.isModified() && A(a.getRoot(), !0),
//             b
//           );
//         }, c.setValue);
//       }
...
//           "true" === localStorage.getItem(t(a, "isLocal")) &&
...
//       function z(a) {
//         for (var b = 0; b < a.__preset_select.length; b++)
//           a.__preset_select[b].value == a.preset &&
//             (a.__preset_select.selectedIndex = b);
//       }
//       function A(a, b) {
...
//             (this.__listening = []),
//             (a = a || {}),
//             (a = o.defaults(a, { autoPlace: !0, width: M.DEFAULT_WIDTH })),
//             (a = o.defaults(a, {
...
//           var d,
//             e = I && "true" === localStorage.getItem(t(this, "isLocal"));
//           if (
...
//                   (a.closed = b),
//                     a.closed
//                       ? n.addClass(c.__ul, M.CLASS_CLOSED)
//                       : n.removeClass(c.__ul, M.CLASS_CLOSED),
//                     this.onResize(),
//                     c.__closeButton &&
...
//                     ((e = a),
//                     a
//                       ? n.bind(window, "unload", d)
//                       : n.unbind(window, "unload", d),
//                     localStorage.setItem(t(c, "isLocal"), a));
//                 },
//               },
//             }),
...
//             (d = function () {
//               I &&
//                 "true" === localStorage.getItem(t(c, "isLocal")) &&
...
//               }),
//                 window.innerHeight - b - G < c
//                   ? (n.addClass(a.domElement, M.CLASS_TOO_TALL),
//                     (a.__ul.style.height = window.innerHeight - b - G + "px"))
//                   : (n.removeClass(a.domElement, M.CLASS_TOO_TALL),
...
//             if (
//               (o.isUndefined(C) &&
//                 ((C = new m()), (C.domElement.innerHTML = b)),
//               this.parent)
//             )
...
//                 -1 == a.__rememberedObjects.indexOf(b) &&
...
//         return function (h, i) {
//           var j = h[i];
//           return g.isArray(arguments[2]) || g.isObject(arguments[2])
//             ? new a(h, i, arguments[2])
//             : g.isNumber(j)
//             ? g.isNumber(arguments[2]) && g.isNumber(arguments[3])
//               ? new c(h, i, arguments[2], arguments[3])
//               : new b(h, i, { min: arguments[2], max: arguments[3] })
//             : g.isString(j)
//             ? new d(h, i)
//             : g.isFunction(j)
//             ? new e(h, i, "")
...
//           var i = function () {
//             if (
//               ((this.__state = a.apply(this, arguments)), this.__state === !1)
//             )
...
//                     [c, f, g],
//                   ][d];
//                 return { r: 255 * i[0], g: 255 * i[1], b: 255 * i[2] };
//               },
...
//                 return (
//                   (d = this.hex_with_component(d, 1, b)),
...
//   (function (a) {
//     function b(c, d) {
//       a.EventEmitter.call(this), (d = d || {}), (window.app = this);
//       var e = this;
//       c.setup
//         ? (c = { default: c })
//         : "function" == typeof c && (c = { default: { setup: c } }),
//         (this.scenes = c),
//         (this.state = b.DEFAULT),
//         (this.bodies = []),
//         (this.springs = []),
//         (this.timeStep = 1 / 60),
//         (this.relaxation = a.Equation.DEFAULT_RELAXATION),
//         (this.stiffness = a.Equation.DEFAULT_STIFFNESS),
//         (this.mouseConstraint = null),
//         (this.nullBody = new a.Body()),
//         (this.pickPrecision = 5),
//         (this.useInterpolatedPositions = !0),
//         (this.drawPoints = []),
//         (this.drawPointsChangeEvent = { type: "drawPointsChange" }),
//         (this.drawCircleCenter = a.vec2.create()),
//         (this.drawCirclePoint = a.vec2.create()),
//         (this.drawCircleChangeEvent = { type: "drawCircleChange" }),
//         (this.drawRectangleChangeEvent = { type: "drawRectangleChange" }),
//         (this.drawRectStart = a.vec2.create()),
//         (this.drawRectEnd = a.vec2.create()),
//         (this.stateChangeEvent = { type: "stateChange", state: null }),
//         (this.newShapeCollisionMask = 1),
//         (this.newShapeCollisionGroup = 1),
//         (this.drawConstraints = !1),
//         (this.stats_sum = 0),
//         (this.stats_N = 100),
...
//             e.world.step(e.world.lastTimeStep);
//           },
//           fps: 60,
//           maxSubSteps: 3,
//           gravityX: 0,
//           gravityY: -10,
//           sleepMode: a.World.NO_SLEEPING,
//           "drawContacts [c]": !1,
//           "drawAABBs [t]": !1,
//           drawConstraints: !1,
//           iterations: 10,
...
//         this.setUpKeyboard(),
//         this.setupGUI(),
//         "undefined" == typeof d.hideGUI && (d.hideGUI = "auto"),
//         (("auto" === d.hideGUI && window.innerWidth < 600) ||
//           d.hideGUI === !0) &&
//           this.gui.close(),
...
//       ];
//     (a.Renderer = b),
//       (b.prototype = new a.EventEmitter()),
//       (b.DEFAULT = 1),
//       (b.PANNING = 2),
//       (b.DRAGGING = 3),
//       (b.DRAWPOLYGON = 4),
...
//       (b.DRAWINGCIRCLE = 7),
//       (b.DRAWRECTANGLE = 8),
//       (b.DRAWINGRECTANGLE = 9),
//       (b.toolStateMap = {
//         "pick/pan [q]": b.DEFAULT,
//         "polygon [d]": b.DRAWPOLYGON,
//         "circle [a]": b.DRAWCIRCLE,
//         "rectangle [f]": b.DRAWRECTANGLE,
//       }),
//       (b.stateToolMap = {});
//     for (var e in b.toolStateMap) b.stateToolMap[b.toolStateMap[e]] = e;
//     (b.keydownEvent = { type: "keydown", originalEvent: null, keyCode: 0 }),
//       (b.keyupEvent = { type: "keyup", originalEvent: null, keyCode: 0 }),
//       Object.defineProperty(b.prototype, "drawContacts", {
//         get: function () {
//           return this.settings["drawContacts [c]"];
//         },
//         set: function (a) {
//           (this.settings["drawContacts [c]"] = a), this.updateGUI();
//         },
//       }),
//       Object.defineProperty(b.prototype, "drawAABBs", {
//         get: function () {
//           return this.settings["drawAABBs [t]"];
//         },
//         set: function (a) {
//           (this.settings["drawAABBs [t]"] = a), this.updateGUI();
//         },
//       }),
...
//         },
//         set: function (a) {
//           (this.resetCallTime = !0),
//             (this.settings["paused [p]"] = a),
//             this.updateGUI();
//         },
//       }),
//       (b.prototype.getDevicePixelRatio = function () {
//         return window.devicePixelRatio || 1;
//       }),
//       (b.prototype.printConsoleMessage = function () {
//         console.log(
//           [
//             "=== p2.js v" + a.version + " ===",
...
//         );
//       }),
//       (b.prototype.resizeToFit = function () {
//         var a = this.getDevicePixelRatio(),
//           b = this.elementContainer.getBoundingClientRect(),
//           c = b.width * a,
//           d = b.height * a;
//         this.resize(c, d);
//       }),
//       (b.prototype.setupGUI = function () {
//         function c() {
//           isNaN(g.gravityX) ||
//             isNaN(g.gravityY) ||
//             a.vec2.set(e.world.gravity, g.gravityX, g.gravityY);
//         }
//         // if ("undefined" != typeof dat) {
//         //   var e = this,
//         //     f = (this.gui = new dat.GUI());
//         //   f.domElement.setAttribute("style", d.join(";"));
//         //   var g = this.settings;
//         //   f.add(g, "tool", b.toolStateMap).onChange(function (a) {
//         //     e.setState(parseInt(a));
//         //   }),
//         //     f.add(g, "fullscreen");
//         //   var h = f.addFolder("World");
//         //   h.open(),
//         //     h.add(g, "paused [p]").onChange(function (a) {
//         //       e.paused = a;
//         //     }),
//         //     h.add(g, "manualStep [s]"),
//         //     h
//         //       .add(g, "fps", 10, 600)
//         //       .step(10)
//         //       .onChange(function (a) {
//         //         e.timeStep = 1 / a;
//         //       }),
//         //     h.add(g, "maxSubSteps", 0, 10).step(1);
//         //   var i = 100;
//         //   h.add(g, "gravityX", -i, i).onChange(c),
//         //     h.add(g, "gravityY", -i, i).onChange(c),
//         //     h
//         //       .add(g, "sleepMode", {
//         //         NO_SLEEPING: a.World.NO_SLEEPING,
//         //         BODY_SLEEPING: a.World.BODY_SLEEPING,
//         //         ISLAND_SLEEPING: a.World.ISLAND_SLEEPING,
//         //       })
//         //       .onChange(function (a) {
//         //         e.world.sleepMode = parseInt(a);
//         //       });
//         //   var j = f.addFolder("Rendering");
//         //   j.open(),
//         //     j.add(g, "drawContacts [c]").onChange(function (a) {
//         //       e.drawContacts = a;
//         //     }),
//         //     j.add(g, "drawAABBs [t]").onChange(function (a) {
//         //       e.drawAABBs = a;
//         //     });
//         //   var k = f.addFolder("Solver");
//         //   k.open(),
//         //     k
//         //       .add(g, "iterations", 1, 100)
//         //       .step(1)
//         //       .onChange(function (a) {
//         //         e.world.solver.iterations = a;
//         //       }),
//         //     k.add(g, "stiffness", 10).onChange(function (a) {
//         //       e.setEquationParameters();
//         //     }),
//         //     k
//         //       .add(g, "relaxation", 0, 20)
//         //       .step(0.1)
//         //       .onChange(function (a) {
//         //         e.setEquationParameters();
//         //       }),
//         //     k
//         //       .add(g, "tolerance", 0, 10)
//         //       .step(0.01)
//         //       .onChange(function (a) {
//         //         e.world.solver.tolerance = a;
//         //       });
//         //   var l = f.addFolder("Scenes");
//         //   l.open();
//         //   var m = 1;
//         //   for (var n in this.scenes) {
//         //     var o = n + " [" + m++ + "]";
//         //     (this.settings[o] = function () {
//         //       e.setScene(e.scenes[n]);
//         //     }),
//         //       l.add(g, o);
//         //   }
//         // }
//       }),
//       (b.prototype.updateGUI = function () {
//         function a(b) {
//           for (var c in b.__controllers) b.__controllers[c].updateDisplay();
//           for (var d in b.__folders) a(b.__folders[d]);
//         }
//         this.gui && a(this.gui);
//       }),
//       (b.prototype.setWorld = function (a) {
//         (this.world = a), (window.world = a);
//         var b = this;
//         a.on("postStep", function (a) {
//           b.updateStats();
//         })
//           .on("addBody", function (a) {
//             b.addVisual(a.body);
//           })
//           .on("removeBody", function (a) {
//             b.removeVisual(a.body);
//           })
//           .on("addSpring", function (a) {
//             b.addVisual(a.spring);
//           })
//           .on("removeSpring", function (a) {
//             b.removeVisual(a.spring);
//           });
//       }),
//       (b.prototype.setScene = function (a) {
//         "string" == typeof a && (a = this.scenes[a]),
//           this.removeAllVisuals(),
//           this.currentScene &&
//             this.currentScene.teardown &&
//             this.currentScene.teardown(),
//           this.world && this.world.clear();
//         for (var b = 0; b < this.addedGlobals.length; b++)
//           delete window[this.addedGlobals];
//         var c = Object.keys(window);
//         if (
//           ((this.currentScene = a),
//           (this.world = null),
//           a.setup.call(this),
...
//         )
//           throw new Error(
//             "The .setup function in the scene definition must run this.setWorld(world);"
//           );
//         for (var d = Object.keys(window), e = [], b = 0; b < d.length; b++)
//           -1 === c.indexOf(d[b]) && "world" !== d[b] && e.push(d[b]);
//         e.length &&
//           (e.sort(),
//           console.log(
//             [
...
//           (this.addedGlobals = e);
//         var f = this.settings;
//         (f.iterations = this.world.solver.iterations),
//           (f.tolerance = this.world.solver.tolerance),
//           (f.gravityX = this.world.gravity[0]),
//           (f.gravityY = this.world.gravity[1]),
//           (f.sleepMode = this.world.sleepMode),
//           this.updateGUI();
//       }),
//       (b.prototype.setSceneByIndex = function (a) {
//         var b = 0;
//         for (var c in this.scenes) {
//           if (b === a) {
//             this.setScene(this.scenes[c]);
//             break;
//           }
//           b++;
//         }
//       }),
//       (b.elementClass = "p2-canvas"),
//       (b.containerClass = "p2-container"),
//       (b.prototype.setUpKeyboard = function () {
//         var a = this;
//         (this.elementContainer.onkeydown = function (c) {
//           if (c.keyCode) {
//             var d = a.state,
//               e = String.fromCharCode(c.keyCode);
//             switch (e) {
//               case "P":
//                 a.paused = !a.paused;
//                 break;
//               case "S":
//                 a.world.step(a.world.lastTimeStep);
//                 break;
//               case "R":
//                 a.setScene(a.currentScene);
//                 break;
//               case "C":
//                 (a.drawContacts = !a.drawContacts),
//                   (a.drawConstraints = !a.drawConstraints);
//                 break;
//               case "T":
//                 a.drawAABBs = !a.drawAABBs;
//                 break;
//               case "D":
//                 a.setState(
//                   d === b.DRAWPOLYGON ? b.DEFAULT : (d = b.DRAWPOLYGON)
//                 );
//                 break;
//               case "A":
//                 a.setState(d === b.DRAWCIRCLE ? b.DEFAULT : (d = b.DRAWCIRCLE));
//                 break;
//               case "F":
//                 a.setState(
//                   d === b.DRAWRECTANGLE ? b.DEFAULT : (d = b.DRAWRECTANGLE)
//                 );
//                 break;
//               case "Q":
//                 a.setState(b.DEFAULT);
//                 break;
//               case "1":
//               case "2":
//               case "3":
...
//               case "8":
//               case "9":
//                 a.setSceneByIndex(parseInt(e) - 1);
//                 break;
//               default:
//                 (b.keydownEvent.keyCode = c.keyCode),
//                   (b.keydownEvent.originalEvent = c),
//                   a.emit(b.keydownEvent);
//             }
//             a.updateGUI();
//           }
//         }),
//           (this.elementContainer.onkeyup = function (c) {
//             if (c.keyCode)
//               switch (String.fromCharCode(c.keyCode)) {
//                 default:
//                   (b.keyupEvent.keyCode = c.keyCode),
//                     (b.keyupEvent.originalEvent = c),
//                     a.emit(b.keyupEvent);
//               }
//           });
//       }),
//       (b.prototype.startRenderingLoop = function () {
//         function a() {
//           if (!b.paused) {
//             var e = Date.now() / 1e3,
//               f = e - d;
//             b.resetCallTime && ((f = 0), (b.resetCallTime = !1)),
//               (d = e),
//               b.world.step(b.timeStep, f, b.settings.maxSubSteps);
//           }
//           b.render(), c(a);
//         }
//         var b = this,
...
//         (this.state = a),
//           (this.stateChangeEvent.state = a),
//           this.emit(this.stateChangeEvent),
//           b.stateToolMap[a] && ((this.settings.tool = a), this.updateGUI());
//       }),
...
//             for (
//               var d,
//                 e = this.world.hitTest(
//                   c,
//                   this.world.bodies,
//                   this.pickPrecision
//                 );
//               e.length > 0 && ((d = e.shift()), d.type === a.Body.STATIC);

//             )
//               d = null;
//             if (d) {
//               d.wakeUp(), this.setState(b.DRAGGING);
//               var f = a.vec2.create();
//               d.toLocalFrame(f, c),
//                 this.world.addBody(this.nullBody),
//                 (this.mouseConstraint = new a.RevoluteConstraint(
//                   this.nullBody,
//                   d,
//                   { localPivotA: c, localPivotB: f }
//                 )),
//                 this.world.addConstraint(this.mouseConstraint);
//             } else this.setState(b.PANNING);
//             break;
//           case b.DRAWPOLYGON:
//             this.setState(b.DRAWINGPOLYGON), (this.drawPoints = []);
//             var g = a.vec2.create();
//             a.vec2.copy(g, c),
//               this.drawPoints.push(g),
//               this.emit(this.drawPointsChangeEvent);
//             break;
//           case b.DRAWCIRCLE:
//             this.setState(b.DRAWINGCIRCLE),
//               a.vec2.copy(this.drawCircleCenter, c),
//               a.vec2.copy(this.drawCirclePoint, c),
//               this.emit(this.drawCircleChangeEvent);
//             break;
//           case b.DRAWRECTANGLE:
//             this.setState(b.DRAWINGRECTANGLE),
//               a.vec2.copy(this.drawRectStart, c),
//               a.vec2.copy(this.drawRectEnd, c),
...
//               (a.vec2.copy(this.mouseConstraint.pivotA, c),
//               this.mouseConstraint.bodyA.wakeUp(),
//               this.mouseConstraint.bodyB.wakeUp());
//             break;
//           case b.DRAWINGPOLYGON:
//             var e = a.vec2.dist(c, this.drawPoints[this.drawPoints.length - 1]);
//             if (e > d * d) {
//               var f = [0, 0];
//               a.vec2.copy(f, c),
//                 this.drawPoints.push(f),
//                 this.emit(this.drawPointsChangeEvent);
//             }
//             break;
//           case b.DRAWINGCIRCLE:
//             a.vec2.copy(this.drawCirclePoint, c),
//               this.emit(this.drawCircleChangeEvent);
//             break;
//           case b.DRAWINGRECTANGLE:
//             a.vec2.copy(this.drawRectEnd, c),
//               this.emit(this.drawRectangleChangeEvent);
//         }
//       }),
...
//               this.setState(b.DEFAULT);
//             break;
//           case b.PANNING:
//             this.setState(b.DEFAULT);
//             break;
//           case b.DRAWINGPOLYGON:
//             this.setState(b.DRAWPOLYGON),
//               this.drawPoints.length > 3 &&
//                 ((d = new a.Body({ mass: 1 })),
//                 d.fromPolygon(this.drawPoints, {
...
//             break;
//           case b.DRAWINGCIRCLE:
//             this.setState(b.DRAWCIRCLE);
//             var e = a.vec2.dist(this.drawCircleCenter, this.drawCirclePoint);
//             if (e > 0) {
//               d = new a.Body({ mass: 0.1, position: this.drawCircleCenter });
//               var f = new a.Circle({ radius: e });
//               d.addShape(f), this.world.addBody(d);
//             }
//             a.vec2.copy(this.drawCircleCenter, this.drawCirclePoint),
//               this.emit(this.drawCircleChangeEvent);
//             break;
//           case b.DRAWINGRECTANGLE:
//             this.setState(b.DRAWRECTANGLE);
//             for (
//               var g = this.drawRectStart, h = this.drawRectEnd, i = 0;
//               2 > i;
//               i++
//             )
//               if (g[i] > h[i]) {
...
//                 (h[i] = g[i]), (g[i] = j);
//               }
//             var k = Math.abs(g[0] - h[0]),
//               l = Math.abs(g[1] - h[1]);
//             if (k > 0 && l > 0) {
//               d = new a.Body({
//                 mass: 0,
//                 position: [
//                   this.drawRectStart[0] + 0.5 * k,
//                   this.drawRectStart[1] + 0.5 * l,
//                 ],
//               });
//               var m = new a.Box({ width: k, height: l });
//               d.addShape(m), this.world.addBody(d);
//             }
//             a.vec2.copy(this.drawRectEnd, this.drawRectStart),
//               this.emit(this.drawRectangleChangeEvent);
//         }
//         if (d) {
//           d.wakeUp();
...
//             var n = d.shapes[i];
//             (n.collisionMask = this.newShapeCollisionMask),
//               (n.collisionGroup = this.newShapeCollisionGroup);
//           }
//         }
//       }),
...
//           this.stats_Nsummed++,
//           this.stats_Nsummed === this.stats_N &&
//             ((this.stats_average = this.stats_sum / this.stats_N),
//             (this.stats_sum = 0),
//             (this.stats_Nsummed = 0));
//       }),
//       (b.prototype.addVisual = function (b) {
//         b instanceof a.LinearSpring
//           ? (this.springs.push(b), this.addRenderable(b))
//           : b instanceof a.Body &&
//             b.shapes.length &&
//             (this.bodies.push(b), this.addRenderable(b));
//       }),
//       (b.prototype.removeAllVisuals = function () {
//         for (var a = this.bodies, b = this.springs; a.length; )
//           this.removeVisual(a[a.length - 1]);
//         for (; b.length; ) this.removeVisual(b[b.length - 1]);
//       }),
//       (b.prototype.removeVisual = function (b) {
//         if ((this.removeRenderable(b), b instanceof a.LinearSpring)) {
//           var c = this.springs.indexOf(b);
//           -1 !== c && this.springs.splice(c, 1);
//         } else if (b instanceof a.Body) {
//           var c = this.bodies.indexOf(b);
//           -1 !== c && this.bodies.splice(c, 1);
//         } else console.error("Visual type not recognized...");
//       }),
//       (b.prototype.createStats = function () {}),
//       (b.prototype.addLogo = function () {
//         var a = [
//           "position:absolute",
//           "left:10px",
//           "top:15px",
...
//         b.innerHTML = [
//           "<div style='" + a.join(";") + "' user-select='none'>",
//           "</div>",
//         ].join("");
//         this.elementContainer.appendChild(b);
//       });

//     (b.zoomInEvent = { type: "zoomin" }),
//       (b.zoomOutEvent = { type: "zoomout" }),
//       (b.prototype.setEquationParameters = function () {
...
//       e.useDeviceAspect &&
//         (e.height = (window.innerHeight / window.innerWidth) * e.width),
//         (this.lineWidth = e.lineWidth),
//         (this.scrollFactor = e.scrollFactor),
//         (this.sleepOpacity = e.sleepOpacity),
//         (this.sprites = []),
//         (this.springSprites = []),
//         (this.debugPolygons = !1),
//         f.call(this, b, c);
//       for (var g in e) this.settings[g] = e[g];
//       (this.pickPrecision = 0.1),
//         this.on("drawPointsChange", function (a) {
//           var b = d.drawShapeGraphics,
//             c = d.drawPoints;
//           b.clear();
...
//             e.push([g[0], g[1]]);
//           }
//           d.drawPath(b, e, 16711680, !1, d.lineWidth, !1);
//         }),
//         this.on("drawCircleChange", function (b) {
//           var c = d.drawShapeGraphics;
//           c.clear();
//           var e = d.drawCircleCenter,
//             f = a.vec2.dist(e, d.drawCirclePoint);
//           d.drawCircle(c, e[0], e[1], 0, f, !1, d.lineWidth);
//         }),
//         this.on("drawRectangleChange", function (a) {
//           var b = d.drawShapeGraphics;
//           b.clear();
//           var c = d.drawRectStart,
//             e = d.drawRectEnd,
//             f = c[0] - e[0],
//             g = c[1] - e[1];
//           d.drawRectangle(
...
//         (c = Math.floor((c + 3 * a[1]) / 4)),
//         (e = Math.floor((e + 3 * a[2]) / 4)),
//         d(b, c, e)
//       );
//     }
//     a.WebGLRenderer = b;
...
//       (b.prototype.stagePositionToPhysics = function (b, c) {
//         var d = c[0],
//           e = c[1];
//         return a.vec2.set(b, d, e), b;
//       });
//     var g = a.vec2.create(),
//       h = a.vec2.create();
...
//                 : e
//               : (Math.pow(e, 2) + h) / g);
//         var i = Math.min(Math.max(e / 2, -1), 1),
//           j = i >= 0;
//         "undefined" != typeof n && d.zoom(n, o, j, void 0, void 0, i);
//       }
//       var c = (this.w, this.h, this.settings),
//         d = this,
//         e =
...
//         i = (this.container = new PIXI.Stage(16777215, !0)),
//         j = (this.element = this.renderer.view);
//       (j.tabIndex = 1),
//         j.classList.add(f.elementClass),
//         j.setAttribute("style", "width:100%;");
//       var k = (this.elementContainer = document.createElement("div"));
//       k.classList.add(f.containerClass),
//         k.setAttribute("style", "width:100%; height:100%"),
//         k.appendChild(j),
//         document.body.appendChild(k),
//         j.focus(),
//         (j.oncontextmenu = function (a) {
//           return !1;
//         }),
//         this.container.addChild(e),
//         (this.drawShapeGraphics = new PIXI.Graphics()),
//         e.addChild(this.drawShapeGraphics),
//         (this.contactGraphics = new PIXI.Graphics()),
//         e.addChild(this.contactGraphics),
//         (this.aabbGraphics = new PIXI.Graphics()),
//         e.addChild(this.aabbGraphics),
//         (e.scale.x = 200),
//         (e.scale.y = -200);
//       var l,
//         m,
...
//         x = 1,
//         y = 0;
//       (i.mousedown = i.touchstart =
//         function (b) {
//           if (
//             ((n = b.global.x),
//             (o = b.global.y),
//             b.originalEvent.touches && (y = b.originalEvent.touches.length),
//             b.originalEvent.touches && 2 === b.originalEvent.touches.length)
//           ) {
//             var c = d.container.interactionManager.touchs[0],
//               f = d.container.interactionManager.touchs[1],
//               i = c.getLocalPosition(e);
//             a.vec2.set(u, i.x, i.y), d.stagePositionToPhysics(s, u);
//             var i = f.getLocalPosition(e);
//             a.vec2.set(u, i.x, i.y),
//               d.stagePositionToPhysics(t, u),
//               (v = a.vec2.dist(s, t));
//             e.scale.x, e.scale.y;
//           } else {
//             (l = b.global.x),
...
//               (q = e.position.y),
//               (r = !0),
//               (d.lastMousePos = b.global);
//             var i = b.getLocalPosition(e);
//             a.vec2.set(g, i.x, i.y),
//               d.stagePositionToPhysics(h, g),
//               d.handleMouseDown(h);
//           }
//         }),
...
//                 (y !== b.originalEvent.touches.length &&
//                   ((l = b.global.x),
//                   (m = b.global.y),
//                   (p = e.position.x),
//                   (q = e.position.y)),
...
//             ) {
//               var c = d.container.interactionManager.touchs[0],
//                 i = d.container.interactionManager.touchs[1],
//                 j = c.getLocalPosition(e);
//               a.vec2.set(u, j.x, j.y), d.stagePositionToPhysics(s, u);
//               var j = i.getLocalPosition(e);
//               a.vec2.set(u, j.x, j.y), d.stagePositionToPhysics(t, u);
//               var k = a.vec2.dist(s, t);
//               return (
//                 a.vec2.add(s, s, t),
//                 a.vec2.scale(s, s, 0.5),
//                 void d.zoom(
//                   0.5 * (c.global.x + i.global.x),
//                   0.5 * (c.global.y + i.global.y),
//                   null,
//                   (k / v) * w,
//                   (k / v) * x
//                 )
...
//             r &&
//               d.state === f.PANNING &&
//               ((e.position.x = b.global.x - l + p),
//               (e.position.y = b.global.y - m + q)),
//               (d.lastMousePos = b.global);
//             var j = b.getLocalPosition(e);
//             a.vec2.set(g, j.x, j.y),
//               d.stagePositionToPhysics(h, g),
//               d.handleMouseMove(h);
//           }),
//         (i.mouseup = i.touchend =
//           function (b) {
//             b.originalEvent.touches && (y = b.originalEvent.touches.length),
//               (r = !1),
//               (n = b.global.x),
//               (o = b.global.y),
//               (d.lastMousePos = b.global);
//             var c = b.getLocalPosition(e);
//             a.vec2.set(g, c.x, c.y),
//               d.stagePositionToPhysics(h, g),
//               d.handleMouseUp(h);
//           }),
//         (this.element.ontouchmove = function (a) {
//           a.preventDefault();
//         }),
//         j.addEventListener
//           ? (j.addEventListener("mousewheel", b, !1),
//             j.addEventListener("DOMMouseScroll", b, !1))
//           : j.attachEvent("onmousewheel", b),
//         this.centerCamera(0, 0);
//     }),
//       (b.prototype.zoom = function (a, b, c, d, e, f) {
//         var g = this.scrollFactor,
//           h = this.stage;
//         "undefined" == typeof d
//           ? (c || (g *= -1),
//             (g *= Math.abs(f)),
//             (h.scale.x *= 1 + g),
//             (h.scale.y *= 1 + g),
//             (h.position.x += g * (h.position.x - a)),
//             (h.position.y += g * (h.position.y - b)))
//           : ((h.scale.x *= d),
//             (h.scale.y *= e),
//             (h.position.x += (d - 1) * (h.position.x - a)),
//             (h.position.y += (e - 1) * (h.position.y - b))),
//           h.updateTransform();
//       }),
//       (b.prototype.centerCamera = function (a, b) {
//         (this.stage.position.x =
//           this.renderer.width / 2 - this.stage.scale.x * a),
//           (this.stage.position.y =
//             this.renderer.height / 2 - this.stage.scale.y * b),
//           this.stage.updateTransform();
//       }),
//       (b.prototype.frame = function (a, b, c, d) {
//         var e = this.renderer.width / this.renderer.height;
//         c / d > e
//           ? ((this.stage.scale.x = this.renderer.width / c),
//             (this.stage.scale.y = -this.stage.scale.x))
//           : ((this.stage.scale.y = -this.renderer.height / d),
//             (this.stage.scale.x = -this.stage.scale.y)),
//           this.centerCamera(a, b);
//       }),
//       (b.prototype.drawCircle = function (a, b, c, d, e, f, g, h) {
//         (g = "number" == typeof g ? g : 1),
//           (f = "number" == typeof f ? f : 16777215),
//           a.lineStyle(g, 0, 1),
//           a.beginFill(f, h ? this.sleepOpacity : 1),
//           a.drawCircle(b, c, e),
//           a.endFill(),
//           a.moveTo(b, c),
//           a.lineTo(b + e * Math.cos(d), c + e * Math.sin(d));
//       }),
//       (b.drawSpring = function (a, b, c, d) {
//         (d = "number" == typeof d ? d : 1),
//           (c = "undefined" == typeof c ? 16777215 : c),
//           a.lineStyle(d, c, 1),
//           10 * d > b && (b = 10 * d);
//         var e = 12,
//           f = b / e;
...
//           1 >= g ||
//             g >= e - 1 ||
//             (g % 2 === 0 ? (i -= 0.1 * b) : (i += 0.1 * b)),
//             a.lineTo(h, i);
//         }
//         a.lineTo(b / 2, 0);
//       }),
//       (b.drawPlane = function (a, b, c, d, e, f, g, h, i) {
//         (f = "number" == typeof f ? f : 1),
//           (d = "undefined" == typeof d ? 16777215 : d),
//           a.lineStyle(f, e, 1),
//           a.lineStyle(0, 0, 0),
//           a.beginFill(d);
//         var j = i;
...
//           a.lineTo(j, 0);
//       }),
//       (b.drawLine = function (b, c, d, e, f, g) {
//         (g = "number" == typeof g ? g : 1),
//           (f = "undefined" == typeof f ? 0 : f),
//           b.lineStyle(g, f, 1);
//         var h = a.vec2.fromValues(-e / 2, 0),
//           i = a.vec2.fromValues(e / 2, 0);
//         a.vec2.rotate(h, h, d),
//           a.vec2.rotate(i, i, d),
//           a.vec2.add(h, h, c),
//           a.vec2.add(i, i, c),
...
//           b.lineTo(i[0], i[1]);
//       }),
//       (b.prototype.drawCapsule = function (a, b, c, d, e, f, g, h, i, j) {
//         (i = "number" == typeof i ? i : 1),
//           (g = "undefined" == typeof g ? 0 : g),
//           a.lineStyle(i, g, 1);
//         var k = Math.cos(d),
//           l = Math.sin(d);
//         a.beginFill(h, j ? this.sleepOpacity : 1),
//           a.drawCircle((-e / 2) * k + b, (-e / 2) * l + c, f),
//           a.drawCircle((e / 2) * k + b, (e / 2) * l + c, f),
//           a.endFill(),
//           a.lineStyle(i, g, 0),
//           a.beginFill(h, j ? this.sleepOpacity : 1),
//           a.moveTo((-e / 2) * k + f * l + b, (-e / 2) * l + f * k + c),
//           a.lineTo((e / 2) * k + f * l + b, (e / 2) * l + f * k + c),
//           a.lineTo((e / 2) * k - f * l + b, (e / 2) * l - f * k + c),
//           a.lineTo((-e / 2) * k - f * l + b, (-e / 2) * l - f * k + c),
//           a.endFill(),
//           a.lineStyle(i, g, 1),
...
//           a.lineTo((e / 2) * k - f * l + b, (e / 2) * l - f * k + c);
//       }),
//       (b.prototype.drawRectangle = function (a, b, c, d, e, f, g, h, i, j) {
//         (i = "number" == typeof i ? i : 1),
//           (g = "number" == typeof g ? g : 16777215),
//           (h = "number" == typeof h ? h : 16777215),
//           a.lineStyle(i),
//           a.beginFill(h, j ? this.sleepOpacity : 1),
//           a.drawRect(b - e / 2, c - f / 2, e, f);
//       }),
//       (b.prototype.drawConvex = function (a, b, c, d, e, f, g, h, i) {
//         if (
//           ((f = "number" == typeof f ? f : 1),
//           (d = "undefined" == typeof d ? 0 : d),
//           g)
//         ) {
//           for (var j = [16711680, 65280, 255], k = 0; k !== b.length + 1; k++) {
//             var l = b[k % b.length],
//               m = b[(k + 1) % b.length],
//               n = l[0],
//               o = l[1],
//               p = m[0],
//               q = m[1];
//             a.lineStyle(f, j[k % j.length], 1),
//               a.moveTo(n, o),
//               a.lineTo(p, q),
//               a.drawCircle(n, o, 2 * f);
//           }
//           a.lineStyle(f, 0, 1), a.drawCircle(h[0], h[1], 2 * f);
//         } else {
//           a.lineStyle(f, d, 1), a.beginFill(e, i ? this.sleepOpacity : 1);
//           for (var k = 0; k !== b.length; k++) {
//             var r = b[k],
//               s = r[0],
//               t = r[1];
//             0 === k ? a.moveTo(s, t) : a.lineTo(s, t);
//           }
//           a.endFill(),
//             b.length > 2 &&
...
//         }
//       }),
//       (b.prototype.drawPath = function (a, b, c, d, e, f) {
//         (e = "number" == typeof e ? e : 1),
//           (c = "undefined" == typeof c ? 0 : c),
//           a.lineStyle(e, c, 1),
//           "number" == typeof d && a.beginFill(d, f ? this.sleepOpacity : 1);
//         for (var g = null, h = null, i = 0; i < b.length; i++) {
//           var j = b[i],
//             k = j[0],
//             l = j[1];
//           if (k !== g || l !== h) {
...
//             a.lineTo(b[0][0], b[0][1]));
//       }),
//       (b.prototype.updateSpriteTransform = function (a, b) {
//         this.useInterpolatedPositions && !this.paused
//           ? ((a.position.x = b.interpolatedPosition[0]),
//             (a.position.y = b.interpolatedPosition[1]),
//             (a.rotation = b.interpolatedAngle))
//           : ((a.position.x = b.position[0]),
//             (a.position.y = b.position[1]),
//             (a.rotation = b.angle));
//       });
//     var i = a.vec2.fromValues(1, 0),
//       j = a.vec2.fromValues(0, 0),
//       k = a.vec2.fromValues(0, 0),
//       l = a.vec2.fromValues(0, 0);
//     (b.prototype.render = function () {
//       for (
//         var b = (this.renderer.width, this.renderer.height, this.springSprites),
//           c = (this.sprites, 0);
//         c !== this.bodies.length;
//         c++
//       )
//         this.updateSpriteTransform(this.sprites[c], this.bodies[c]);
//       for (var c = 0; c !== this.bodies.length; c++) {
//         var d = this.bodies[c].sleepState === a.Body.SLEEPING,
//           e = this.sprites[c],
//           f = this.bodies[c];
//         e.drawnSleeping !== d &&
//           (e.clear(),
//           this.drawRenderable(f, e, e.drawnColor, e.drawnLineColor));
//       }
//       for (var c = 0; c !== this.springs.length; c++) {
//         var g = this.springs[c],
//           e = b[c],
//           h = g.bodyA,
//           m = g.bodyB;
//         if (
//           (this.useInterpolatedPositions && !this.paused
//             ? (a.vec2.toGlobalFrame(
//                 k,
//                 g.localAnchorA,
//                 h.interpolatedPosition,
//                 h.interpolatedAngle
//               ),
//               a.vec2.toGlobalFrame(
//                 l,
//                 g.localAnchorB,
//                 m.interpolatedPosition,
//                 m.interpolatedAngle
//               ))
//             : (g.getWorldAnchorA(k), g.getWorldAnchorB(l)),
//           (e.scale.y = 1),
//           k[1] < l[1])
//         ) {
//           var n = k;
...
//           (j[0] = o - q),
//           (j[1] = p - r),
//           (e.rotation = Math.acos(a.vec2.dot(i, j) / a.vec2.length(j))),
//           (e.scale.x = a.vec2.length(j) / g.restLength);
//       }
...
//         var s = this.contactGraphics;
//         s.lineStyle(this.lineWidth, 0, 1);
//         for (
//           var c = 0;
//           c !== this.world.narrowphase.contactEquations.length;
//           c++
//         ) {
//           var t = this.world.narrowphase.contactEquations[c],
//             u = t.bodyA,
//             v = t.bodyB,
//             w = t.contactPointA,
//             x = t.contactPointB,
...
//             B = v.position[1];
//           s.moveTo(y, z),
//             s.lineTo(y + w[0], z + w[1]),
//             s.moveTo(A, B),
//             s.lineTo(A + x[0], B + x[1]);
//         }
//         this.contactGraphics.cleared = !1;
//       } else
//         this.contactGraphics.cleared ||
//           (this.contactGraphics.clear(), (this.contactGraphics.cleared = !0));
//       if (this.drawAABBs) {
//         this.aabbGraphics.clear(),
//           this.stage.removeChild(this.aabbGraphics),
//           this.stage.addChild(this.aabbGraphics);
//         var s = this.aabbGraphics;
//         s.lineStyle(this.lineWidth, 0, 1);
//         for (var c = 0; c !== this.world.bodies.length; c++) {
//           var C = this.world.bodies[c].getAABB();
//           s.drawRect(
//             C.lowerBound[0],
//             C.lowerBound[1],
//             C.upperBound[0] - C.lowerBound[0],
//             C.upperBound[1] - C.lowerBound[1]
//           );
//         }
//         this.aabbGraphics.cleared = !1;
//       } else
//         this.aabbGraphics.cleared ||
//           (this.aabbGraphics.clear(), (this.aabbGraphics.cleared = !0));
//       this.followBody &&
//         app.centerCamera(
//           this.followBody.interpolatedPosition[0],
//           this.followBody.interpolatedPosition[1]
//         ),
//         this.renderer.render(this.container);
//     }),
//       (b.prototype.drawRenderable = function (c, d, e, f) {
//         var g = this.lineWidth;
//         if (
//           ((d.drawnSleeping = !1),
//           (d.drawnColor = e),
//           (d.drawnLineColor = f),
//           c instanceof a.Body && c.shapes.length)
//         ) {
//           var h = c.sleepState === a.Body.SLEEPING;
//           if (((d.drawnSleeping = h), c.concavePath && !this.debugPolygons)) {
//             for (var i = [], j = 0; j !== c.concavePath.length; j++) {
//               var k = c.concavePath[j];
//               i.push([k[0], k[1]]);
//             }
//             this.drawPath(d, i, f, e, g, h);
//           } else
//             for (var l = 0; l < c.shapes.length; l++) {
//               var m = c.shapes[l],
//                 n = m.position,
//                 o = m.angle;
//               if (m instanceof a.Circle)
//                 this.drawCircle(d, n[0], n[1], o, m.radius, e, g, h);
//               else if (m instanceof a.Particle)
//                 this.drawCircle(d, n[0], n[1], o, 2 * g, f, 0);
//               else if (m instanceof a.Plane)
//                 b.drawPlane(d, -10, 10, e, f, g, 10 * g, 10 * g, 100);
//               else if (m instanceof a.Line) b.drawLine(d, n, o, m.length, f, g);
//               else if (m instanceof a.Box)
//                 this.drawRectangle(
//                   d,
//                   n[0],
//                   n[1],
...
//                   h
//                 );
//               else if (m instanceof a.Capsule)
//                 this.drawCapsule(
//                   d,
//                   n[0],
//                   n[1],
...
//                   h
//                 );
//               else if (m instanceof a.Convex) {
//                 for (
//                   var p = [], q = a.vec2.create(), j = 0;
//                   j !== m.vertices.length;
//                   j++
//                 ) {
//                   var k = m.vertices[j];
//                   a.vec2.rotate(q, k, o), p.push([q[0] + n[0], q[1] + n[1]]);
//                 }
//                 this.drawConvex(
//                   d,
//                   p,
...
//                   h
//                 );
//               } else if (m instanceof a.Heightfield) {
//                 for (var i = [[0, -100]], j = 0; j !== m.heights.length; j++) {
//                   var k = m.heights[j];
//                   i.push([j * m.elementWidth, k]);
//                 }
//                 i.push([m.heights.length * m.elementWidth, -100]),
//                   this.drawPath(d, i, f, e, g, h);
//               }
//             }
//         } else if (c instanceof a.Spring) {
//           var r = c.restLength;
//           b.drawSpring(d, r, 0, g);
//         }
//       }),
//       (b.prototype.addRenderable = function (b) {
//         var c = (this.lineWidth, parseInt(e(), 16)),
//           d = 0,
//           f = new PIXI.Graphics();
//         b instanceof a.Body && b.shapes.length
//           ? (this.drawRenderable(b, f, c, d),
//             this.sprites.push(f),
//             this.stage.addChild(f))
//           : b instanceof a.Spring &&
//             (this.drawRenderable(b, f, 0, d),
//             this.springSprites.push(f),
//             this.stage.addChild(f));
//       }),
//       (b.prototype.removeRenderable = function (b) {
//         if (b instanceof a.Body) {
//           var c = this.bodies.indexOf(b);
//           -1 !== c &&
//             (this.stage.removeChild(this.sprites[c]),
//             this.sprites.splice(c, 1));
//         } else if (b instanceof a.Spring) {
//           var c = this.springs.indexOf(b);
//           -1 !== c &&
//             (this.stage.removeChild(this.springSprites[c]),
//             this.springSprites.splice(c, 1));
//         }
//       }),
